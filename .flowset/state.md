...
- **최근 갱신 (§15 Sprint 016 M1 T07 + T08 시나리오 2·3 cover 완료 + 학습 #17)**: 2026-05-20 (§10~§14 시점 + **§15 PR #194 시나리오 2·3 회귀 셋 10 케이스 + 본 docs PR (예정 #195)** 머지 — 본 세션 evaluator + codex 병렬 평가 **누적 15회** (§14.7 시점 13회 + PR #194 + 본 docs PR) + PR 내 hotfix 누적 **27건** (§14.7 시점 20건 + PR #194 codex hotfix 3건 + 본 docs PR codex hotfix 4건 = 27건) / 단위 **1144 PASS** (1134 + S2 5 + S3 5) / KI 잔여 17 동수 (closed 후보 6종 + KI-001 T25 판단 + KI-018/019 산식 example 적용) / **PR 누적 95** (§14.7 시점 92 + PR #193 + #194 + 본 docs PR = #195) / **시나리오 회귀 18/18 cover 100% 달성** (S1 5/5 + S2 5/5 + S3 5/5 + S4 3/3) / **가드레일 G-011 → G-018** (동수) / **학습 누적** #5 + #8 + #13 + #14 + #15 + #16 + **#17 (G-016 자기 검출 + 정정 — `Skill(codex:rescue)` 호출 시도 → raw MCP `sandbox=read-only` 정정)** / **자동 강제 path 5-layer + slash skill 호출 매처 mini-milestone δ 후보** (호출 자체 사전 차단 hook). 자기 검증 루프 **15회차 SUCCESS** (#181~#194 + 본 docs PR = #181~#195). 본 세션 종료 검증: lint + typecheck + test 1144 PASS + chat_meta schema 정합 강제 (isValidChatMetaTable) + KI-018 산식 example 박음.
- **다음 세션 진입점**: `.flowset/handoffs/2026-05-20.md` **§15 PR #194 머지 직후 (시나리오 회귀 18/18 cover 달성)** — **권고 0순위 T02-followup** (KI-006 실 구현, G-013 2단계, KI-014 재측정) / **1순위 Sprint 016 M2** (어댑터 일괄 제거 T09~T13) / **2순위 KI-018 50 페어 자체 셋 + S1-C3 chat_meta schema hotfix** (codex BLOCKING #1 후속). **시나리오 회귀 100% cover 상태 — 다음 세션 KI MEDIUM 실 구현 + 어댑터 정리 진입**. 정합된 dual review 표준 + G-017 잔존 브랜치 정리 + G-018 산출물 매트릭스 정확성 + 자동 강제 path 5-layer (slash skill 호출 매처 후속 검토).
...
- [2026-05-20](./handoffs/2026-05-20.md) — Sprint 016 M0 §1~§14 + §15 M1 T07 + T08 시나리오 2·3 cover (#194 + docs #195) 완료 — 시나리오 회귀 18/18 cover 100% 달성 (S2 + S3 5+5 신규), 단위 1144 PASS, KI closed 후보 6종 + KI-018/019 산식 example, 자기 검증 루프 15회차 SUCCESS, 가드레일 G-018, 학습 7종 (#17 G-016 자기 검출), 다음 세션 T02-followup 진입
