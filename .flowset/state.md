...
- **Sprint**: **018 M2 T17a 머지 완료 (#254 `c2bec41`) — 본 state 동기화 docs PR 진행 중**. 누적 main first-parent S018 PR: **8** (#246~#254 feat/docs, 본 docs PR 머지 시 9). M0+M1 종료 + **M2 진입(T17a)**. 다음 = **T17b** (IndexingService/searchHandlers dimension 분기 + VectorIndex `vec_pages_1024` 전환 + services.ts 마이그레이션 체인 wiring).
