...
- **Phase**: **3 진행 중 (Sprint 018 M5 T12 종료 — Sprint 018 종합 + known-issues §통계 off-by-one 정정 / closeout #272 `7f095f8` 머지)** (**M0~M4 + M5 T12 종료 → T13 잔여**). carryover **T13 1 작업** (Sprint 019 contract 시안. T20 = Sprint 019 defer → T13 에 흡수). Sprint 018 = **27 PR (#246~#272)** / 단위 1760→**1950** (+190) / KI 잔여 **8**. **codex 019e6e4d 우선순위 협의 완결 (write-path→T17e→T21→T22/T09→PRD v0.5.0→Phase3 종료 전부 머지) + 019e71da M5 PR 분해 협의 (closeout 분리 #272 → T12 본 PR → T13 별도).**
- **Sprint**: **018 M5 T12 종료 (Sprint 018 종합 + known-issues §통계 정정)**. 누적 main first-parent S018 PR: **27** (#246~#272 — `git log --first-parent main --grep=WI-S018` 실측, closeout #272 포함) → 본 T12 머지 시 28. M0~M4 + M5 T12 종료. 다음 = **T13 (Sprint 019 contract 시안)** → 머지 시 **Sprint 018 완전 종료**. ⚠️ T13 진입 = 사용자 명시 선택 후 (G-022).
...
- **다음 진입점** (Sprint 018 M5 T12 종료 → T13 잔여 / Sprint 018 완전 종료 직전):
  ...
  - (완료: **Sprint 018 M0~M4 + M5 T12** — mini-β PR B/C[#248] / T19 Notion spec[#250] / Schema v06 spec[#252] / T17a~e[#254~#264] + write-path[#262] / T21 공유 시안[#266] / T22·T09[#268] / T10 PRD v0.5.0[#270] / T11 Phase 3 체크리스트[#271] / closeout[#272] / **T12 Sprint 018 종합+§통계 정정[본 PR]**)
