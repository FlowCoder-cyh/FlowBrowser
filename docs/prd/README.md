# FlowBrowser AI PRD v0.3.9 — 목차

본 문서는 FlowBrowser AI 제품 요구사항 명세(PRD)의 **v0.3.9** 버전이며, 13개 섹션 파일로 분할되어 있다.
...
**Phase 1 진행 중 — Sprint 001~011 완료**

Phase 0 5종 Spike + Phase 1 Sprint 001~011 완료. v0.3.9에서는 Sprint 011 (summary abort API + 탭 컬러 라벨 + 탭 핀) 실측 반영.
...
| **v0.3.9** | **2026-05-15** | **Sprint 011 실측 반영 (summary abort API + 탭 컬러 라벨 + 탭 핀), 현재** |
