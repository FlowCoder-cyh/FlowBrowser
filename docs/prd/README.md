# FlowBrowser AI PRD v0.3.3 — 목차

본 문서는 FlowBrowser AI 제품 요구사항 명세(PRD)의 **v0.3.3** 버전이며, 13개 섹션 파일로 분할되어 있다.
...
**Phase 1 진행 중 — Sprint 001·002·003·004·005 완료**

Phase 0 5종 Spike + Phase 1 Sprint 001~005 완료. v0.3.3에서는 Sprint 005 (캐시 키 확장 / 용어집 / 요약 폭주 보호) 실측 반영.
...
| **v0.3.3** | **2026-05-15** | **Sprint 005 실측 반영 (캐시 키 확장 / 용어집 + invalidation / 요약 폭주 보호), 현재** |
