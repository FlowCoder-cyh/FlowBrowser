...
| # | 섹션 | 상태 | 내용 |
|---|---|---|---|
| 04 | [데이터 모델 (Data Model)](./04_data_model.md) | 📝 (b3) | Entity ERD + anchor 키 + forward-compatibility |
| 05 | [CRUD 매트릭스 (CRUD Matrix)](./05_crud_matrix.md) | 📝 (b3) | Entity × Actor + IPC 채널 + 라이프사이클 |
