# FlowBrowser AI PRD v0.3.8 — 목차

본 문서는 FlowBrowser AI 제품 요구사항 명세(PRD)의 **v0.3.8** 버전이며, 13개 섹션 파일로 분할되어 있다.
...
**Phase 1 진행 중 — Sprint 001~010 완료**

Phase 0 5종 Spike + Phase 1 Sprint 001~010 완료. v0.3.8에서는 Sprint 010 (탭 드래그/순서 변경 + 탭 컨텍스트 메뉴 + cancel-on-switch UX + isCurrentTab 순수 함수 추출) 실측 반영.
...
| **v0.3.8** | **2026-05-15** | **Sprint 010 실측 반영 (탭 드래그/순서 + 탭 컨텍스트 메뉴 + cancel-on-switch UX + isCurrentTab 순수 함수 추출), 현재** |
